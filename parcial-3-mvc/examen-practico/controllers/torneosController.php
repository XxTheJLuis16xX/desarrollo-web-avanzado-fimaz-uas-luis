...
class torneosController
{
    ...
    {
        return ($this->model->update($id, $nombreTorneo, $organizador, $patrocinadores, $sede, $categoria, $premio1, $premio2, $premio3, $otroPremio, $usuario, $contrasena))
            ? header("Location: readAllTorneos.php")
            : header("Location: updateTorneo.php?id=" . $id);
    }
