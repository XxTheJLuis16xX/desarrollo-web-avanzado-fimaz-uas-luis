...
// Incluye las configuraciones de sesión, el token de seguridad CSRF,
// los estilos de Bootstrap y la barra de navegación del sistema.
...
// Cierra el contenedor de Bootstrap y finaliza de manera limpia las etiquetas del árbol HTML.
